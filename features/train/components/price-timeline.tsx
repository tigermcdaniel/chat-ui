...
interface TrainPriceTimelineProps {
  destination: string
  currentPrice: number
  typicalPrice: number
  minPrice: number
...
export function TrainPriceTimeline({
  destination,
  currentPrice,
  typicalPrice,
  minPrice,
  maxPrice,
  savings,
}: TrainPriceTimelineProps) {
  const [isExpanded, setIsExpanded] = useState(false)

  // Train price history data spanning 60 days
  const priceHistory = [
    { date: "60 days ago", price: 145, label: "60 days ago" },
    { date: "57 days ago", price: 140, label: "" },
    { date: "54 days ago", price: 138, label: "" },
    { date: "51 days ago", price: 135, label: "" },
    { date: "48 days ago", price: 130, label: "48 days ago" },
    { date: "45 days ago", price: 128, label: "" },
    { date: "42 days ago", price: 125, label: "" },
    { date: "39 days ago", price: 122, label: "" },
    { date: "36 days ago", price: 120, label: "" },
    { date: "34 days ago", price: 118, label: "34 days ago" },
    { date: "32 days ago", price: 115, label: "" },
    { date: "30 days ago", price: 120, label: "" },
    { date: "28 days ago", price: 125, label: "" },
    { date: "26 days ago", price: 122, label: "" },
    { date: "24 days ago", price: 118, label: "" },
    { date: "22 days ago", price: 105, label: "" },
    { date: "20 days ago", price: 95, label: "20 days ago" },
    { date: "18 days ago", price: 100, label: "" },
    { date: "16 days ago", price: 105, label: "" },
    { date: "14 days ago", price: 110, label: "" },
    { date: "12 days ago", price: 115, label: "" },
    { date: "10 days ago", price: 150, label: "" },
    { date: "8 days ago", price: 145, label: "" },
    { date: "6 days ago", price: 140, label: "6 days ago" },
    { date: "4 days ago", price: 135, label: "" },
    { date: "2 days ago", price: 130, label: "" },
    ...
    <Card className="bg-green-50 border-green-200">
      <CardContent className="p-4">
        ...
        <div className="flex items-center justify-between cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-gray-700">
              Train tickets are usually cheaper when booked 2-4 weeks in advance
            </span>
          </div>
          {isExpanded ? (
        ...
        <div className="flex items-center gap-2 mt-2 text-sm text-gray-600">
          <span>
            Train prices during this time for similar trips to {destination} are ${savings} cheaper on average.
          </span>
          ...
          <div className="mt-6 space-y-6">
            ...
            <div>
              <h4 className="text-base font-medium text-gray-900 mb-3">
                Train prices are currently typical for your search
              </h4>

              <div className="space-y-3">
                <div className="flex items-center justify-between text-sm text-gray-600">
                  <span>Train tickets for similar trips to {destination}</span>
                  <Info className="w-4 h-4 text-gray-400" />
                </div>
                ...
                <div className="relative mt-4">
                  ...
                  <div className="relative h-2 bg-gradient-to-r from-green-400 via-yellow-400 to-red-400 rounded-full">
                    ...
                    <div
                      className="absolute top-1/2 transform -translate-y-1/2 -translate-x-1/2 w-4 h-4 bg-green-500 border-2 border-white rounded-full shadow-md"
            ...
            {/* Price History Chart */}
            <div>
              <h4 className="text-base font-medium text-gray-900 mb-4">Train price history for this search</h4>
              ...
              <div className="relative">
                ...
                <div className="ml-14 relative h-40 bg-white rounded border border-gray-100">
                  ...
                  <svg className="absolute inset-2 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                    ...
                    <path d={generateAreaPath()} fill="rgba(34, 197, 94, 0.1)" stroke="none" />
              ...
              <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
                <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                  ...
                  <div className="text-green-600">${minHistoryPrice} (20 days ago)</div>
                </div>
